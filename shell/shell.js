...
(function () {
  ...
  var LEGAL_DOCS = {
    ...
    privacy: {
      title: '개인정보 처리방침',
      // TODO: 실제 개인정보 처리방침 작성 후 교체. legal/ 폴더에 privacy-policy.md를
      // 추가한 뒤 이 위치에 변환된 HTML을 붙여 넣기.
      html: [
        '<h2>개인정보 처리방침</h2>',
        '<p>현재 개인정보 처리방침은 별도로 작성 중입니다. 약관과 함께 정식 출시 전까지 게시될 예정입니다.</p>',
        '<p>문의: contact@everydaysummer.net</p>'
      ].join('')
    }
  };
